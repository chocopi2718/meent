...
#         minimum_pattern_size = (4 * fourier_order + 1) * pmt.shape[1]  # TODO: what is theoretical minimum?
...
#             pmtvy_fft_cut = (pmtvy_fft[-2*fourier_order + center: center + 2*fourier_order + 1])
